    ...
    <section className="about" id="about">
      ...
      <div className="about-content">
        ...
        <p>
          ...
          <strong> HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong>, and 
          <strong> React</strong>, which allow me to bring my designs to life.  
        </p>
        <p>
        ...
        <p>
          Outside of work, I enjoy art, photography, and exploring new ideas that 
